---
title: 'Lect 3: How to Run TopoSUB'
...
## TopoSUB simulation folder

A TopoSUB simulation folder exists of
...
* [gdal](http://www.gdal.org/) and [proj4](https://github.com/OSGeo/proj.4)
