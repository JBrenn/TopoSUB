...
d3heatmap(var_dev[,-dim(var_dev)[[2]]], Rowv=F, Colv=F, scale = "none", cellnote = cellnote[,-dim(var_dev)[[2]]], labRow = paste(listpoints$landcover, "-", round(listpoints$slp,0), "-", listpoints$IDpoint, sep=" "), dendrogram = "none")
